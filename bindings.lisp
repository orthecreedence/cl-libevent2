...
(cffi:defcenum #.(lispify "evhttp_connection_state" 'enumname)
	#.(lispify "EVCON_DISCONNECTED" 'enumvalue :keyword)
	#.(lispify "EVCON_CONNECTING" 'enumvalue :keyword)
	#.(lispify "EVCON_IDLE" 'enumvalue :keyword)
	#.(lispify "EVCON_READING_FIRSTLINE" 'enumvalue :keyword)
	#.(lispify "EVCON_READING_HEADERS" 'enumvalue :keyword)
	#.(lispify "EVCON_READING_BODY" 'enumvalue :keyword)
	#.(lispify "EVCON_READING_TRAILER" 'enumvalue :keyword)
	#.(lispify "EVCON_WRITING" 'enumvalue :keyword))

(cffi:defcstruct #.(lispify "evhttp_connection" 'classname)
	(#.(lispify "tqe_next" 'slotname) :pointer)
	(#.(lispify "tqe_prev" 'slotname) :pointer)
	(#.(lispify "fd" 'slotname) :int)
	(#.(lispify "bufev" 'slotname) :pointer)
	(#.(lispify "retry_ev" 'slotname) :pointer)
	(#.(lispify "bind_address" 'slotname) :string)
	(#.(lispify "bind_port" 'slotname) :pointer)
	(#.(lispify "address" 'slotname) :string)
	(#.(lispify "port" 'slotname) :pointer)
	(#.(lispify "max_headers_size" 'slotname) :unsigned-long)
	(#.(lispify "max_body_size" 'slotname) :pointer)
	(#.(lispify "flags" 'slotname) :int)
	(#.(lispify "timeout" 'slotname) :int)
	(#.(lispify "retry_cnt" 'slotname) :int)
	(#.(lispify "retry_max" 'slotname) :int)
	(#.(lispify "state" 'slotname) #.(lispify "evhttp_connection_state" 'enumname))
	(#.(lispify "http_server" 'slotname) :pointer)
	(#.(lispify "tqh_first" 'slotname) :pointer)
	(#.(lispify "tqh_last" 'slotname) :pointer)
	(#.(lispify "cb" 'slotname) :pointer)
	(#.(lispify "cb_arg" 'slotname) :pointer)
	(#.(lispify "closecb" 'slotname) :pointer)
	(#.(lispify "closecb_arg" 'slotname) :pointer)
	(#.(lispify "read_more_deferred_cb" 'slotname) :pointer)
	(#.(lispify "base" 'slotname) :pointer)
	(#.(lispify "dns_base" 'slotname) :pointer))

(cffi:defcstruct #.(lispify "evhttp_request" 'classname)
	(#.(lispify "tqe_next" 'slotname) :pointer)
	(#.(lispify "tqe_prev" 'slotname) :pointer)
	(#.(lispify "evcon" 'slotname) :pointer)
	(#.(lispify "flags" 'slotname) :int)
	(#.(lispify "input_headers" 'slotname) :pointer)
	(#.(lispify "output_headers" 'slotname) :pointer)
	(#.(lispify "remote_host" 'slotname) :string)
	(#.(lispify "remote_port" 'slotname) :unsigned-short)
	(#.(lispify "host_cache" 'slotname) :string)
	(#.(lispify "kind" 'slotname) #.(lispify "evhttp_request_kind" 'enumname))
	(#.(lispify "type" 'slotname) #.(lispify "evhttp_cmd_type" 'enumname))
	(#.(lispify "headers_size" 'slotname) :unsigned-long)
	(#.(lispify "body_size" 'slotname) :unsigned-long)
	(#.(lispify "uri" 'slotname) :string)
	(#.(lispify "uri_elems" 'slotname) :pointer)
	(#.(lispify "major" 'slotname) :char)
	(#.(lispify "minor" 'slotname) :char)
	(#.(lispify "response_code" 'slotname) :int)
	(#.(lispify "response_code_line" 'slotname) :string)
	(#.(lispify "input_buffer" 'slotname) :pointer)
	(#.(lispify "ntoread" 'slotname) :pointer)
	(#.(lispify "chunked" 'slotname) :unsigned-int)
	(#.(lispify "userdone" 'slotname) :unsigned-int)
	(#.(lispify "output_buffer" 'slotname) :pointer)
	(#.(lispify "cb" 'slotname) :pointer)
	(#.(lispify "cb_arg" 'slotname) :pointer)
	(#.(lispify "chunk_cb" 'slotname) :pointer))
