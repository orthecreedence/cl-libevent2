...
(cffi:defcstruct #.(lispify "sockaddr_in_bsd" 'classname)
	(#.(lispify "sin_len" 'slotname) :char)
	(#.(lispify "sin_family" 'slotname) :char)
	(#.(lispify "sin_port" 'slotname) :unsigned-short)
	(#.(lispify "sin_addr" 'slotname) :unsigned-int)
	(#.(lispify "sin_zero_0" 'slotname) :char)
	(#.(lispify "sin_zero_1" 'slotname) :char)
...
(cl:defconstant #.(lispify "_EVENT_NUMERIC_VERSION" 'constant) #x02001500)
...
(cl:defconstant #.(lispify "LIBEVENT_VERSION_NUMBER" 'constant) #x02001500)
...
(cffi:defcstruct #.(lispify "bufferevent" 'classname)
	...
	(#.(lispify "wm_read" 'slotname) (:pointer (:struct #.(lispify "event_watermark" 'classname))))
	(#.(lispify "wm_write" 'slotname) (:pointer (:struct #.(lispify "event_watermark" 'classname))))
	...
	(#.(lispify "timeout_read" 'slotname) (:pointer (:struct #.(lispify "timeval" 'classname))))
	(#.(lispify "timeout_write" 'slotname) (:pointer (:struct #.(lispify "timeval" 'classname))))
...
(cffi:defcfun ("evbuffer_search" #.(lispify "evbuffer_search" 'function)) (:pointer (:struct #.(lispify "evbuffer_ptr" 'classname)))
  (buffer :pointer)
  (what :string)
  (len :unsigned-long)
  (start :pointer))

(cffi:defcfun ("evbuffer_search_range" #.(lispify "evbuffer_search_range" 'function)) (:pointer (:struct #.(lispify "evbuffer_ptr" 'classname)))
  (buffer :pointer)
  (what :string)
  (len :unsigned-long)
  (start :pointer)
...
(cffi:defcfun ("evbuffer_search_eol" #.(lispify "evbuffer_search_eol" 'function)) (:pointer (:struct #.(lispify "evbuffer_ptr" 'classname)))
  (buffer :pointer)
  (start :pointer)
  (eol_len_out :pointer)
  (eol_style #.(lispify "evbuffer_eol_style" 'enumname)))
